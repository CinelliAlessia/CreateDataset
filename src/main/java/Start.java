...
public class Start {
    public static ProjectName projectName = ProjectName.ZOOKEEPER; // "ZOOKEEPER" or "BOOKKEEPER"
    public static void main(String[] string) {
        try {
            ...
            RetrieveLOCForVersions.getLOCForVersions(projectName,getLocalRepositoryPath(), getCsvFilePath());
